    ...
    switch (data.state) {
      ...
      case "END":
        ...
        axios
          ...
          .then(() => {
            ctx.reply(
              "✅ Спасибо, что вы ответили на все вопросы. Убедительная просьба внести пожертвования до начала события, чтобы место за вами было закреплено.<br/>Вы можете это сделать, передав одному из организаторов или связавшись с Александром Байгазиным <b>(@Ailuropoda88)</b> <i>+375 (33) 643-66-99</i>",
              Markup.removeKeyboard()
            );
